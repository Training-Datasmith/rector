...
use Php_Stan\Type\Accessory\Has_Offset_Value_Type;
 ...
 */
final class Has_Offset_Value_Type_Type_Mapper implements Type_Mapper_Interface
{
    public function get_node_class(): string
    {
        return Has_Offset_Value_Type::class;
    }
    /**
